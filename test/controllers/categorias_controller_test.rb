...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { categoria: @categoria.categoria, empresa_id: @categoria.empresa_id } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { categoria: @categoria.categoria, empresa_id: @categoria.empresa_id } }
