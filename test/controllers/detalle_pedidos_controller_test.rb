...
class DetallePedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle_pedido" do
    assert_difference('DetallePedido.count') do
      post detalle_pedidos_url, params: { detalle_pedido: { actualizado_por: @detalle_pedido.actualizado_por, cantidad: @detalle_pedido.cantidad, creado_por: @detalle_pedido.creado_por, estado: @detalle_pedido.estado, observacion: @detalle_pedido.observacion, pedido_id: @detalle_pedido.pedido_id, producto_id: @detalle_pedido.producto_id } }
    end
  ...
  test "should update detalle_pedido" do
    patch detalle_pedido_url(@detalle_pedido), params: { detalle_pedido: { actualizado_por: @detalle_pedido.actualizado_por, cantidad: @detalle_pedido.cantidad, creado_por: @detalle_pedido.creado_por, estado: @detalle_pedido.estado, observacion: @detalle_pedido.observacion, pedido_id: @detalle_pedido.pedido_id, producto_id: @detalle_pedido.producto_id } }
